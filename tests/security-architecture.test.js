...
if (typeof sandbox.sanitizeURL !== "function") {
  ...
  if (sanitizeURL("/\\evil.com/xss") !== "") { console.error("FAIL backslash-obfuscated protocol-relative URL allowed"); failures++; }
  if (sanitizeURL("/\\\\evil.com/xss") !== "") { console.error("FAIL double-backslash-obfuscated protocol-relative URL allowed"); failures++; }
}
