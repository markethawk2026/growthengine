...
if (typeof sandbox.sanitizeURL !== "function") {
  ...
  if (sanitizeURL("/\\evil.com/xss") !== "") { console.error("FAIL protocol-relative backslash URL allowed"); failures++; }
  if (sanitizeURL("/\\\\evil.com/xss") !== "") { console.error("FAIL protocol-relative multi-backslash URL allowed"); failures++; }
}
