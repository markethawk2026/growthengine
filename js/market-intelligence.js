...
// Performance optimization: accept pre-computed breadth result to eliminate redundant quote fetches
async function leaders(symbols){
  var b=(symbols && Array.isArray(symbols.rows)) ? symbols : await breadth(symbols);
