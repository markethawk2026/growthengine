...
async function leaders(symbols){
  // Bolt Optimization: Reuse pre-computed market breadth data if provided (symbols.rows)
  // to avoid redundant quoteRows API/fetch overhead for the dynamic universe.
  var b=(symbols&&symbols.rows)?symbols:await breadth(symbols);
