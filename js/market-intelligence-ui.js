...
async function render(){
  ...
  try{
    // Fetch market breadth and sector performance in parallel, then pass pre-fetched breadth to leaders()
    // to avoid fetching quote rows for the workspace universe twice.
    var results=await Promise.all([NCMarketIntelligence.breadth(),NCMarketIntelligence.sectorPerformance()]);
    var b=results[0], s=results[1];
    var l=await NCMarketIntelligence.leaders(null, b);
    body.innerHTML=
