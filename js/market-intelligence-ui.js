...
async function render(){
  ...
  try{
    // Compute breadth once, then pass pre-computed breadth to leaders to prevent duplicate quote fetches
    var b=await NCMarketIntelligence.breadth();
    var secondPass=await Promise.all([NCMarketIntelligence.leaders(b),NCMarketIntelligence.sectorPerformance()]);
    var l=secondPass[0], s=secondPass[1];
    body.innerHTML=
