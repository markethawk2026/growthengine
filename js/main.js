...
function initPredictionAndOutlookHandlers() {
  ...
  if (tmBtn && tmIn) {
    var triggerTM = function() {
      var val = tmIn.value.trim() || window.activeTickerNode;
...
document.addEventListener("DOMContentLoaded", function() {
  initThemeSwitcher();
  initPredictionAndOutlookHandlers();
});
bootDashboard();
